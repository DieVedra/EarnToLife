...
public class ZombiePool : PoolMetods
{
    ...
    public ZombiePool(ParticleSystem bloodHitEffectPrefab, ParticleSystem bloodEffectPrefab,
        Factory factory, Transform bloodEffectsPoolParent)
    {
    ...
    {
        return _factory.CreateEffect(_bloodHitEffectPrefab, _bloodEffectsPoolParent);
    }
    private ParticleSystem CreateBloodEffect()
    {
        return _factory.CreateEffect(_bloodEffectPrefab, _bloodEffectsPoolParent);
    }
